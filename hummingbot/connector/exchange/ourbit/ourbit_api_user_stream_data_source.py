...
class OurbitAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    _ousds_logger: Optional[HummingbotLogger] = None
    ...
    def logger(cls) -> HummingbotLogger:
        if cls._ousds_logger is None:
            cls._ousds_logger = logging.getLogger(__name__)
        return cls._ousds_logger
    ...
    async def _subscribe_channels(self, ws: WSAssistant):
        ...
        """
        try:
            # Subscribe to execution reports (trade updates)
            trade_payload = {"method": "SUBSCRIBE", "params": ["executionReport"], "id": 1}
            subscribe_trade_request: WSJSONRequest = WSJSONRequest(payload=trade_payload)

            # Subscribe to balance updates
            balance_payload = {"method": "SUBSCRIBE", "params": ["outboundAccountPosition"], "id": 2}
