...
class OurbitAuth(AuthBase):
    ...
    async def ws_authenticate(self, request: WSRequest) -> WSRequest:
        """
        This method is intended to configure a websocket request to be authenticated. Ourbit does not use this
        functionality
        """
    ...
    def get_referral_code_headers(self):
        """
        Generates authentication headers required by Ourbit
